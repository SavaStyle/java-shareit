...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    Booking findFirstByItemIdAndStartBeforeOrderByEndDesc(long itemId, LocalDateTime end);

    Booking findFirstByItemIdAndStartAfterAndStatusIsNotOrderByStartAsc(Long itemId, LocalDateTime end, BookingStatus status);
