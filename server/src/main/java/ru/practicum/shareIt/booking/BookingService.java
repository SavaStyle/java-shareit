...
public interface BookingService {
    ...
    Booking findFirstByItemIdAndStartBeforeOrderByEndDesc(long ownerId, LocalDateTime end);

    Booking findFirstByItemIdAndStartAfterAndStatusIsNotOrderByStartAsc(long itemId, LocalDateTime end);
